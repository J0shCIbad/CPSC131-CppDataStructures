    ...
    _groceries_sl_list( initList.begin(), initList.end() )
{
  ...
  {
    _groceries_array[_groceries_array_size] = *p;
  }
}
...
GroceryList & GroceryList::operator+=( const GroceryList & rhs )
{
  ///////////////////////// TO-DO //////////////////////////////
    ...
    //mySol
    for(auto it=rhs._groceries_vector.begin(); it!=rhs._groceries_vector.end(); it++) {
		  insert(*it, Position::BOTTOM);
    }
  /////////////////////// END-TO-DO ////////////////////////////
...
std::size_t GroceryList::find( const GroceryItem & item ) const
{
  ...
  ///////////////////////// TO-DO //////////////////////////////
    ...
    //mySol
    for(int i=0; i<_groceries_array_size; i++){
      if(_groceries_array[i] == item)
        return i;
    }
    return -1;
  /////////////////////// END-TO-DO ////////////////////////////
...
void GroceryList::insert( const GroceryItem & item, std::size_t offsetFromTop )       // insert new item at offsetFromTop, which places it before the current item at offsetFromTop
{
  ...
  ///////////////////////// TO-DO //////////////////////////////
    /// Silently discard duplicate items from getting added to the grocery list.  If the to-be-inserted item is already in the list,
    /// simply return.
    //mySol
  ...
  /**********  Insert into array  ***********************/
  {
    ///////////////////////// TO-DO //////////////////////////////
      ...
      if(_groceries_array_size < _groceries_array.size()){
        for(int i=_groceries_array_size; i>offsetFromTop; i--){
          _groceries_array[i]=_groceries_array[i-1];
        }
        _groceries_array[offsetFromTop] = item;
        _groceries_array_size++;
      }else{
        throw CapacityExceeded_Ex("Capacity Exceeded Error");
      }
  ...
  /**********  Insert into vector  **********************/
  {
    ///////////////////////// TO-DO //////////////////////////////
      ...
      //mySol
    auto p = _groceries_vector.begin();
    for(int i=0; i<offsetFromTop; i++) p++;
      _groceries_vector.insert(p, item);
    /////////////////////// END-TO-DO ////////////////////////////
  }
  ...
  /**********  Insert into doubly linked list  **********/
  {
    ///////////////////////// TO-DO //////////////////////////////
      ...
      //mySol
    auto p = _groceries_dl_list.begin();
    for(int i=0; i<offsetFromTop; i++) p++;
    _groceries_dl_list.insert(p, item);
    /////////////////////// END-TO-DO ////////////////////////////
  }
  ...
  /**********  Insert into singly linked list  **********/
  {
    ///////////////////////// TO-DO //////////////////////////////
      ...
      //mySol
    auto p = _groceries_sl_list.before_begin();
    for(int i=0; i<offsetFromTop; i++) p++;
    _groceries_sl_list.insert_after(p, item);
    /////////////////////// END-TO-DO ////////////////////////////
  }
  // Verify the internal grocery list state is still consistent amongst the four containers
  if( !containersAreConsistant() ) throw GroceryList::InvalidInternalState_Ex( "Container consistency error" exception_location );
...
void GroceryList::remove( std::size_t offsetFromTop )
{
  ...
  /**********  Remove from array  ***********************/
  {
    ///////////////////////// TO-DO //////////////////////////////
      ...
      //mySol
      for(int i=offsetFromTop+1; i<_groceries_array_size; i++){
  ...
  /**********  Remove from singly linked list  **********/
  {
    ///////////////////////// TO-DO //////////////////////////////
      ...
      auto p = _groceries_sl_list.before_begin();
      for(int i=0; i<offsetFromTop; i++) p++;
      _groceries_sl_list.erase_after(p);
    /////////////////////// END-TO-DO ////////////////////////////
  }
  // Verify the internal grocery list state is still consistent amongst the four containers
  if( !containersAreConsistant() ) throw GroceryList::InvalidInternalState_Ex( "Container consistency error" exception_location );
...
void GroceryList::moveToTop( const GroceryItem & item )
{
  ///////////////////////// TO-DO //////////////////////////////
    ...
    if(i == -1) {return;}
      ...
      remove(i);
      insert(item, GroceryList::Position::TOP);
    }
  /////////////////////// END-TO-DO ////////////////////////////
}
